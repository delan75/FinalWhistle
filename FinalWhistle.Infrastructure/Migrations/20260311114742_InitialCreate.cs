        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    IsLockedForPredictions = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasExtraTime = table.Column<bool>(type: "bit", nullable: false),
                    ExtraTimeHomeGoals = table.Column<int>(type: "int", nullable: true),
                    ExtraTimeAwayGoals = table.Column<int>(type: "int", nullable: true),
                    HasPenalties = table.Column<bool>(type: "bit", nullable: false),
                    PenaltiesHomeScore = table.Column<int>(type: "int", nullable: true),
                    PenaltiesAwayScore = table.Column<int>(type: "int", nullable: true),
                    EnteredByAdminId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Predictions_MatchId_UserId",
                table: "Predictions",
